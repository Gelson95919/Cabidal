...
class fechoDia(models.Model):
      _name = 'fecho.dia'
      _description = 'Fecho Dia Hotel'

      data = fields.Date(string="Data")
      checkin_ids = fields.One2many('reserva', 'feixo_dia_id', string="Check-in")

     #verifica e entender esse funcao
          ...
          for line in terms_obj:
              ...
              data.update(
                  {'habitacao_id': line.habitacao_id, 'montante_check_kin': line.montante_check_kin, 'cliente_ids': line.cliente_ids, 'start_date': line.start_date,
                   'end_date': line.end_date, 'nume_pessoa': line.nume_pessoa, 'hab_id': line.hab_id, 'num_criancas': line.num_criancas})
